...
const renderList = (list) => {
    list.forEach((person) => {
        ...
        box.addEventListener("click", clickToMove);
...
function clickToMove(student) {
    const studentEl = student.target;
    if (studentEl.parentElement.id === "away") {
        present.appendChild(studentEl);
    } else {
      away.appendChild(studentEl);
    }
}
